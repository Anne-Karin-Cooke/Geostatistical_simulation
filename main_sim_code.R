...
# system call to run shell script to launch simulation remotely on cluster
# system("sh /home/acooke/sim.sh")

#####

## download results and write into dateframe
system("rsync -arv -e 'ssh -p port_number' cooke@localhost:/output* /home/acooke/Sims/Sph_20m_30percent/")
